...
public class SetCompanyOwnerCommandHandler(IHairDbContext dbContext, UserManager<ApplicationUser> userManager) 
    : IRequestHandler<SetCompanyOwnerCommand, string>
{
